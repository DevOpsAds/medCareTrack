...
def modal_estoque(request, medicamento_id):
    ...
    print(estoque)
    return render(request, 'modal_estoque.html', {'estoque': estoque})
...
def detalhe_medicamento(request, medicamento_id):
    try:
        modal_estoque(request,medicamento_id)
        medicamento = MedicamentoExtendido.objects.get(medicamento_id=medicamento_id)
        return render(request, 'detalhe_medicamento_modal_estoque.html', {'medicamento': medicamento})
