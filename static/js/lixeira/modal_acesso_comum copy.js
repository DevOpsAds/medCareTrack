...
$('#myModal_acesso_comum').on('click', 'button[type="submit"]', function(event) {
    ...
    if (form[0].checkValidity()) {
        ...
        var user_pk = $('#id_usuario_principal').val();  // Corrigido para obter o valor corretamente
        console.log("PPPPPPPPPPPPPPPPPP",user_pk);
        console.log(typeof user_pk)
        ...
        $.ajax({
            ...
            data: {
                ...
                'email': $('#id_email').val(),
                'senha': $('#id_senha').val(),
                'usuario_principal_id': user_pk, // Corrigido para enviar o valor correto
